...
Mobile.tap(findTestObject('android.widget.Button - Histrico de Partidas'), 0)
...
Mobile.tap(findTestObject('Object Repository/android.widget.CheckedTextView - Durao (Menor)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.Button - Aplicar'), 0)

Mobile.tap(findTestObject('android.widget.Spinner (1)'), 0)

Mobile.tap(findTestObject('Object Repository/android.widget.CheckedTextView - Durao (Maior)'), 0)
